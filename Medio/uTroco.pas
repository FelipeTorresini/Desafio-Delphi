...
const
  // tentei mas nao achei utilidade quando resolvi o desafio...
...
begin
  ...
  // lResto recebe o ATotal para que seja trabalho apenas com a subtração do total com a quantidade
  // senao, caira nos if mais de uma vez calculando a quantidade e o total novamente...
  lResto := ATotal;
